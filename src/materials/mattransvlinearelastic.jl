...
function MaterialModels.material_response(mp::MatTransvLinearElastic, ε::SymmetricTensor{2,dim,T,M}, ::MatTransvLinearElasticState, Δt=nothing; cache=nothing, options=nothing) where {dim,T,M}
