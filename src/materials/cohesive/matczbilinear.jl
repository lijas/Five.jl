...
function MaterialModels.material_response(mp::MatCZBilinear{T}, J::Vec{3,T}, prev_state::MatCZBilinearState, Δt=nothing; cache=nothing, options=nothing)  where {T}
...
#2D
function MaterialModels.material_response(mp::MatCZBilinear{T}, J2d::Vec{2,T}, prev_state::MatCZBilinearState, Δt=nothing; cache=nothing, options=nothing)  where {T}
